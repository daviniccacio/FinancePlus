...
export default function TransactionTable({ transacoesPaginadas, totalPaginas, paginaAtual, setPaginaAtual, setIsModalAberto, exportarPDF, prepararEdicao, setIdExclusaoConfirmar }) {
    ...
    <section className="bg-white rounded-2xl border border-gray-200/60 overflow-hidden shadow-sm w-full">
      ...
      {transacoesPaginadas.length === 0 ? (
        <div className="flex flex-col items-center justify-center p-12 text-center bg-white">
          ...
          <button onClick={() => setIsModalAberto(true)} className="mt-4 flex items-center gap-1 bg-blue-500 text-white text-xs font-semibold px-4 py-2 rounded-xl hover:bg-blue-600 transition-colors shadow-sm active:scale-95">
